...
multichainCli = "multichain-cli -datadir=~/.multichain-client -port=19255 -rpcport=19254 game "
...
class NameForm(FlaskForm):
    playername = StringField('Client name', validators=[DataRequired()])
